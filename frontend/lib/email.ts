export async function sendWelcomeEmail(
  ...
  const from = 'Echo Copy Trading <onboarding@resend.dev>';
  const subject = 'Welcome to Echo Copy Trading!';
  ...
  const html = `
    <div style="font-family: sans-serif; background-color: #0d0d0d; color: #ffffff; padding: 40px 20px; border-radius: 12px; max-width: 600px; margin: 0 auto;">
      <h2 style="color: #f59e0b; font-weight: 300; border-bottom: 1px solid #27272a; padding-bottom: 12px; margin-bottom: 20px;">Welcome to Echo</h2>
      ...
      <p style="font-size: 12px; color: #52525b; border-top: 1px solid #27272a; padding-top: 15px; margin-top: 30px;">
        Echo is built on Somnia Shannon Testnet. All assets, including aUSD and STT, are simulated.
      </p>
    </div>
  `;
...
export async function sendTradeOpenedEmail(
  ...
  const html = `
    <div style="font-family: sans-serif; background-color: #0d0d0d; color: #ffffff; padding: 40px 20px; border-radius: 12px; max-width: 600px; margin: 0 auto;">
      ...
      ${explorerLink}
      <p style="font-size: 12px; color: #52525b; border-top: 1px solid #27272a; padding-top: 15px; margin-top: 30px;">
        Echo is built on Somnia Shannon Testnet. All assets, including aUSD and STT, are simulated. Manage your notification preferences from your profile.
      </p>
    </div>
  `;
...
export async function sendVerificationCode(
  ...
  const from = 'Echo Copy Trading <onboarding@resend.dev>';
  const subject = `${code} is your Echo verification code`;
  ...
  const html = `
    <div style="font-family: sans-serif; background-color: #0d0d0d; color: #ffffff; padding: 40px 20px; border-radius: 12px; max-width: 600px; margin: 0 auto;">
      ...
      <p style="font-size: 14px; line-height: 1.6; color: #a1a1aa;">
        Enter the code below in Echo to confirm this email address. It expires in 10 minutes.
      </p>
