...
//   ╚████╔╝ ██║  ██║╚██████╔╝███████╗██║
//
//  VaultManager — Echo copy-trading core contract
 ...
 * @title  VaultManager
 * @author Echo Team
 * @notice Core contract for Echo copy-trading.
 *
 ...
 *         │     Fetches latest swap by the leader from the Echo API.      │
 *         │                                                                 │
...
contract VaultManager {
     ...
     *         fetches the leader's latest swap from the Echo API.
     *
    ...
    function _buildPrompt(
        ...
        string memory header = string.concat(
            "You are a risk management engine for Echo, a copy-trading platform on Somnia.\n",
