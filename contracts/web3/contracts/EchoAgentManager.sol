...
//  ███████║   ██║   ███████╗███████╗███████╗██║  ██║███████╗██║     ██║  ██║██║  ██║
//
//  EchoAgentManager - Autonomous copy-trading via Somnia Agent Platform
...
contract EchoAgentManager {
    ...
    string public constant ECHO_API =
        "https://api.echo.xyz/v1/leader/";
    ...
    function checkLeaderActivity(address follower) external payable {
        ...
        string memory url = string.concat(ECHO_API, _toHexString(p.leader), "/latest-swap");
