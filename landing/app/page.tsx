    ...
    <>
      ...
      <main className="viewport-layout" id="main-viewport">
        ...
        <header className="header-row">
          ...
          <a
            href="https://echo-agent.vercel.app/"
      ...
      {/* Footer Row — floats just above the ECHO stencil */}
      ...
      {/* Massive ECHO Stencil & Animation Layer */}
      ...
      <section className="content-section features">
        <h2 className="section-title">Why Echo</h2>
        <div className="features-grid">
          <div className="feature-card">
            <h3>Non-custodial vaults</h3>
            <p>Your funds stay in a smart contract vault you control — Echo never takes custody of your assets.</p>
          </div>
          <div className="feature-card">
      ...
      <footer className="site-footer">
        <span>© 2026 Echo · Built on Somnia Testnet</span>
        <div className="site-footer-links">
          <a href="https://echo-agent.vercel.app/traders">Leaderboard</a>
          <a href="https://echo-agent.vercel.app/watcher">Live Activity</a>
          <a href="https://echo-agent.vercel.app/">Launch App</a>
        </div>
      </footer>
    </>
  );
