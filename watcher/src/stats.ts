...
export const STAT_AI_CALLS   = 'echo:stats:aiCalls:today';
export const STAT_EXECUTIONS = 'echo:stats:executions:today';
export const STAT_EVALUATED  = 'echo:stats:evaluated:today';
